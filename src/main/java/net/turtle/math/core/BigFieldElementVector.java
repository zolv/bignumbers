...
public abstract class BigFieldElementVector< T extends FieldElement< T > > implements FieldElement< BigVector< T > > , BigVector< T > {
	...
	protected abstract BigFieldElementVector< T > createInstance( final List< T > coordinatesSum );
	...
	protected boolean isSameDimensionAs( BigVector< T > other ) {
		return this.coordinates.size() == other.getCoordinates().size();
	}
	
	protected void checkDimensions( BigVector< T > other ) {
