...
public abstract class BigFieldElementVector<
        F extends BigFieldElement<F>, V extends BigFieldElementVector<F, V>>
    implements BigFieldElement<V>, BigVector<F, V> {
  ...
  /**
   * There is no official way to inversing vector. This method just uses inversion of every
   * coordinate. Not so usefull but...
   */
  @Override
  public V inverse() {
