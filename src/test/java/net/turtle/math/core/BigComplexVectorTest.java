...
public class BigComplexVectorTest {
	...
	public void testAdd() {
		{
			final BigComplexVector bv1 = new BigComplexVector( new BigComplex( "1" ), new BigComplex( "2" ), new BigComplex( "3" ) );
			final BigComplexVector bv2 = new BigComplexVector( new BigComplex( "2" ), new BigComplex( "4" ), new BigComplex( "8" ) );
			final BigComplexVector r1 = new BigComplexVector( new BigComplex( "3" ), new BigComplex( "6" ), new BigComplex( "11" ) );
	...
	public void testSubstract() {
		{
			final BigComplexVector bv1 = new BigComplexVector( new BigComplex( "3" ), new BigComplex( "2" ), new BigComplex( "1" ) );
			final BigComplexVector bv2 = new BigComplexVector( new BigComplex( "2" ), new BigComplex( "4" ), new BigComplex( "6" ) );
			final BigComplexVector r1 = new BigComplexVector( new BigComplex( "1" ), new BigComplex( "-2" ), new BigComplex( "-5" ) );
	...
	public void testMultiply_BigComplex() {
		{
			final BigComplexVector bv1 = new BigComplexVector( new BigComplex( "1" ), new BigComplex( "2" ), new BigComplex( "-3" ) );
			final BigComplexVector r1 = new BigComplexVector( new BigComplex( "3" ), new BigComplex( "6" ), new BigComplex( "-9" ) );
			Assert.assertArrayEquals( r1.getCoordinates().toArray(), bv1.multiply( new BigComplex( "3" ) ).getCoordinates().toArray() );
		}
	}
	...
	public void testDivide_BigComplex() {
		{
			final BigComplexVector bv1 = new BigComplexVector( new BigComplex( "1" ), new BigComplex( "2" ), new BigComplex( "-3" ) );
			final BigComplexVector r1 = new BigComplexVector( new BigComplex( "1/3" ), new BigComplex( "2/3" ), new BigComplex( "-1" ) );
			Assert.assertArrayEquals( r1.getCoordinates().toArray(), bv1.divide( new BigComplex( "3" ) ).getCoordinates().toArray() );
		}
	}
	...
	public void testInverse() {
		{
			final BigComplexVector bv1 = new BigComplexVector( new BigComplex( "3" ), new BigComplex( "2" ), new BigComplex( "1" ) );
			final BigComplexVector r1 = new BigComplexVector( new BigComplex( "1/3" ), new BigComplex( "1/2" ), new BigComplex( "1" ) );
	...
	public void testNegate() {
		{
			final BigComplexVector bv1 = new BigComplexVector( new BigComplex( "3" ), new BigComplex( "2" ), new BigComplex( "1" ) );
			final BigComplexVector r1 = new BigComplexVector( new BigComplex( "-3" ), new BigComplex( "-2" ), new BigComplex( "-1" ) );
